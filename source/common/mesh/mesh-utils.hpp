...
namespace our::mesh_utils {
    ...
    Mesh* triangle(const rp3d::Vector3& v0,const rp3d::Vector3& v1,const rp3d::Vector3& v2, const uint32_t& c0, const uint32_t& c1, const uint32_t& c2);
    // create line
    Mesh* line(const rp3d::Vector3& v0,const rp3d::Vector3& v1, const uint32_t& c0, const uint32_t& c1);
}